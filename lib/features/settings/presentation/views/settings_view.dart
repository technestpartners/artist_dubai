...
class SettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final userName = storage.getString('user_name') ?? 'Allen';
    final userEmail = storage.getString('user_email') ?? 'allenbaiyee@me.com';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // "Account Settings" Sub-Header with Back Arrow & Home Action (Matching media_1787987695070.png)
            Container(
              color: Colors.white,
              ...
              child: ListView(
                ...
                children: [
                  if (!isLoggedIn)
                    ...
                    // Card 1: Account Information (Exact match to media_1787987695070.png)
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        color: Colors.white,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          _buildAccountField('Member Since', '27 November 2025'),
                          const SizedBox(height: 16),
                    ...
                    // Card 2: Artist Profile (Exact match to media_1787987695070.png)
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        color: Colors.white,
                    ...
                    // Card 3: Account Actions (Exact match to media_1787987695070.png)
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        color: Colors.white,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text(
                              'Note: Account deletion requests are processed manually for security reasons. After clicking "Delete Account", you\'ll be signed out and our team will process your request within 7 business days. You\'ll receive a confirmation email once the deletion is complete.',
                              style: TextStyle(
                                fontSize: 12.5,
                                color: Color(0xFF64748B),
                                height: 1.45,
