...
class ArtEventModel {
  ...
  static List<ArtEventModel> get mockEvents => const [
    ArtEventModel(
      ...
      price: '20.00 AED',
      description:
          'Experience art at Demo Event 10 with creators and live showcases.',
    ...
    ArtEventModel(
      ...
      price: '10.00 AED',
      description:
          'Experience art at Demo Event 1 with creators and live showcases.',
      requirements: 'Valid ticket required at the entrance.',
    ...
    ArtEventModel(
      ...
      price: 'Free',
      description:
          'Showcase your talent and connect with international art collectors.',
    ...
    ArtEventModel(
      ...
      price: 'Free',
      description:
          'Exclusive gallery presentation of contemporary street & architectural photography.',
